...
Donate link: https://globalbizsol.com
...
<code>[gbscatalog]</code>

= To use in Template file =
<code><?php echo do_shortcode('[gbscatalog]');?></code>
...
1. Displays settings available in the plugin.
2. Displays Products Showcase.
